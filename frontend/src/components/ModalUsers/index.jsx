...
import QueueSelectCustom from "../QueueSelect";
...
const ModalUsers = ({ open, onClose, userId, companyId }) => {
  ...
  const handleSaveUser = async (values) => {
    const userData = { ...values, companyId, queueIds: selectedQueueIds, super: superUser };
    try {
      if (userId) {
        await api.put(`/users/${userId}`, userData);
      } else {
        await api.post("/users/fromCompany", userData);
      }
