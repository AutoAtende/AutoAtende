...
const MessageVariablesPicker = ({ onClick, disabled }) => {
    ...
    const msgVars = [
        ...
        {
            name: i18n.t("messageVariablesPicker.vars.ticketId"),
            value: "{{ticket_id}}"
        },
        {
            name: i18n.t("messageVariablesPicker.vars.greeting"),
            value: "{{greeting}}"  // Note: Check for typo in 'gretting', should it be 'greeting'?
        },
        {
        ...
        {
            name: i18n.t("messageVariablesPicker.vars.dataHora"),
            value: "{{data_hora}}"
        },
        {
        ...
        {
            name: i18n.t("messageVariablesPicker.vars.nameCompany"),
            value: "{{name_company}}"
        }
    ];
