...
const Options = ({
  ...
  // Estado para armazenar configurações - SEM SPREAD OPERATOR
  ...
  // Carregar configurações iniciais - SEM SPREAD OPERATOR
  useEffect(() => {
    ...
    try {
      ...
      // SEM SPREAD - usando Object.assign
  ...
  // Atualizar configuração local e notificar alteração - SEM SPREAD
