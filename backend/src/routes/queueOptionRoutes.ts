...
queueOptionRoutes.post("/queue-options/:queueOptionId/media-upload", isAuth, upload.array("file"), QueueOptionController.mediaUpload);
queueOptionRoutes.delete("/queue-options/:queueOptionId/media-upload", isAuth, QueueOptionController.deleteMedia);
